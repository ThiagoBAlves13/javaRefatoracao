...
public class PetService {
    ...
    public void listarPetsAbrigo() throws InterruptedException, IOException {
    ...
    public void importarPetsAbrigo() throws InterruptedException, IOException {
        System.out.println("Digite o id ou nome do abrigo:");
        String idOuNome = new Scanner(System.in).nextLine();
        ...
        while ((line = reader.readLine()) != null) {
            ...
            String uri = "http://localhost:8080/abrigos/" + idOuNome + "/pets";
            HttpResponse<String> response = clientHTTPConfig.dispararRequisicaoPost(uri, json);
